...
import ContactUsHero from "../../../../../Images/ContactUsHero.png";
import {
  Fb,
  Ig,
  linkedin,
...
const ContactUs = () => {
  ...
  useEffect(() => {
    ...
    const countrySelectorButton = document.querySelector(
      ".react-international-phone-country-selector-button"
    );

    if (phoneInputContainer && countrySelectorButton) {
      // Remove the border from the countrySelectorButton
      countrySelectorButton.style.border = "none";
      countrySelectorButton.style.borderRadius = "0px";
      countrySelectorButton.style.borderBottom =
        "0.5px solid var(--Foundation-Grey-grey-600, #565759)";
    }
  }, []);
  ...
  const onSubmit = async (data) => {
    try {
      const url = `${BaseUrl}/create-contact-us`;
      ...
      toast.success(response.data.message && "Your Query has been submitted!");
      reset();
    } catch (error) {
  ...
  return (
    <Container>
      <ToastContainer />
      <Row className={style.ContactUsMain}>
        <Col>
          <div className={style.ContactUsMainText}>
        ...
        <Col className={style.contactUSImg} style={{ padding: "0px" }}>
          <img src={ContactUsHero} alt="" />
        </Col>
      </Row>

      <Row
        className={style.ContactUsFormMain}
        ...
        >
          <div className={style.ContactFrom}>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className={style.textFieldMain}>
                <h6>First Name</h6>
                <input
              ...
              <div className={style.textFieldMain}>
                ...
                <PhoneInput
                  ...
                  style={{
                    width: "100%",
                    border: "none",
                    "--react-international-phone-boder": "#fff",
                    "--react-international-phone-border-radius": 0,
                  }}
                  onChange={(phone) => setPhone(phone)}
                  placeholder="1234567890"
                  countrySelectorStyleProps={style.CountrySelect}
                  inputStyle={{
                    border: "none",
                    borderBottom:
                      "0.5px solid var(--Foundation-Grey-grey-600, #565759)",
