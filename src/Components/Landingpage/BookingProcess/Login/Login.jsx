...
import { addUserDetail } from "../../../../Redux/UserSlice/UserSlice";
...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      dispatch(addUserDetail(res.data.data));
      let finalPrice = localStorage.getItem("finalPrice");
      let bookingMode = localStorage.getItem("bookingMode");
      navigate(
        `/bookingProcess/pickup-info/${carType}/${finalPrice}/${bookingMode}`
      );
